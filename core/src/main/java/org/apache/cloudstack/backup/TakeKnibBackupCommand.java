...
public class TakeKnibBackupCommand extends Command {
    ...
    private String backupParentImageStoreUrl;

    private List<KnibTO> knibTOs;

    public TakeKnibBackupCommand(boolean quiesceVm, boolean runningVM, boolean endChain, String vmName, String imageStoreUrl, String backupParentImageStoreUrl, List<KnibTO> knibTOs) {
        this.quiesceVm = quiesceVm;
        this.runningVM = runningVM;
        this.endChain = endChain;
        this.vmName = vmName;
        this.imageStoreUrl = imageStoreUrl;
        this.backupParentImageStoreUrl = backupParentImageStoreUrl;
    ...
    public String getBackupParentImageStoreUrl() {
        return backupParentImageStoreUrl;
    }
