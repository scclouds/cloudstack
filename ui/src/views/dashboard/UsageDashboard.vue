...
export default {
  ...
  methods: {
    fetchData () {
      this.stats = [{}, {}, {}, {}, {}, {}]
      api('listVirtualMachines', { state: 'Running', listall: true, onlyretrieveresourcecount: true }).then(json => {
        var count = 0
      ...
      api('listVirtualMachines', { state: 'Stopped', listall: true, onlyretrieveresourcecount: true }).then(json => {
        var count = 0
        if (json && json.listvirtualmachinesresponse) {
          count = json.listvirtualmachinesresponse.count
        }
      ...
      api('listVirtualMachines', { listall: true, onlyretrieveresourcecount: true }).then(json => {
        var count = 0
        if (json && json.listvirtualmachinesresponse) {
          count = json.listvirtualmachinesresponse.count
        }
      ...
      api('listVolumes', { listall: true, onlyretrieveresourcecount: true }).then(json => {
        var count = 0
      ...
      api('listNetworks', { listall: true, onlyretrieveresourcecount: true }).then(json => {
        var count = 0
      ...
      api('listPublicIpAddresses', { listall: true, onlyretrieveresourcecount: true }).then(json => {
        var count = 0
