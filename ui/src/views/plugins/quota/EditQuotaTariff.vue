...
<script>
import { api } from '@/api'
import { moment, getMomentFormattedAndNormalized, getMomentNormalizedToDatePicker } from '@/utils/date'
    ...
    handleSubmit (e) {
      ...
      this.formRef.value.validate().then(() => {
        ...
        if (this.resource.endDate !== values.endDate) {
          params.enddate = getMomentFormattedAndNormalized({ value: values.endDate })
        }
