...
public class ProjectManagerImplTest {
    ...
    private static final String PROJECT_UUID = "db549f65-27ed-4fcf-a042-7c66f96921b3";
    ...
    private void setAccessProjectTests() {
        ...
        Mockito.lenient().doReturn(projectMock).when(projectManagerImpl).getProject(PROJECT_ID);
    ...
    public void canAccountAccessProjectTestAccountNotExists() {
        ...
        Assert.assertFalse(projectManagerImpl.canAccountAccessProject(ACCOUNT_ID, PROJECT_ID));
    }
    @Test
    public void canAccountAccessProjectTestAccountIsRootAdmin() {
        ...
        Assert.assertTrue(projectManagerImpl.canAccountAccessProject(ACCOUNT_ID, PROJECT_ID));
    }
    @Test
