...
public class HypervisorHostHelper {
    ...
    public static boolean createBlankVm(VmwareHypervisorHost host, String vmName, String vmInternalCSName, int cpuCount, int cpuSpeedMHz, int cpuReservedMHz,
        ...
        Pair<DiskControllerMappingVO, DiskControllerMappingVO> updatedControllerInfo = VmwareHelper.convertRecommendedDiskControllers(controllerInfo, null, host, guestOsIdentifier);
        Set<DiskControllerMappingVO> requiredDiskControllers = VmwareHelper.getRequiredDiskControllers(updatedControllerInfo, systemVm);
