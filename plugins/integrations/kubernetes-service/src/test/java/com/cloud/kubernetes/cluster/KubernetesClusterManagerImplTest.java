...
public class KubernetesClusterManagerImplTest {
    ...
    public void testValidateServiceOfferingNodeType() {
        ...
        kubernetesClusterManager.validateServiceOfferingForNode(map, 1L, WORKER.name(), version);
    ...
    public void testValidateServiceOfferingNodeTypeInvalidOffering() {
        ...
        kubernetesClusterManager.validateServiceOfferingForNode(map, 1L, WORKER.name(), null);
    }
