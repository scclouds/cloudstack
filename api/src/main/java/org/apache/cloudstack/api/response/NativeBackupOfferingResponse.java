...
public class NativeBackupOfferingResponse extends BaseResponse {
    ...
    public NativeBackupOfferingResponse(String id, String name, Boolean compress, Boolean validate, Boolean allowQuickRestore, Boolean allowExtractFile, Date created,
            Date removed) {
    ...
    public Boolean getAllowQuickRestore() {
        return allowQuickRestore;
    }

    public Boolean getAllowExtractFile() {
