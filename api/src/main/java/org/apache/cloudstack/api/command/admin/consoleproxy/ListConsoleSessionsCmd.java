...
package org.apache.cloudstack.api.command.admin.consoleproxy;
...
@APICommand(name = "listConsoleSessions", description = "Lists all console sessions.", responseObject = ConsoleSessionResponse.class,
        entityType = {ConsoleSession.class}, since = "4.18.0.14-scclouds",
