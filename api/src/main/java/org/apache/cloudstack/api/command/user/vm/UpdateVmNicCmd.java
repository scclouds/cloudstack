...
public class UpdateVmNicCmd extends BaseAsyncCmd {
    ...
    public String getEventDescription() {
        return String.format("Updating NIC %s.", _uuidMgr.getUuid(Nic.class, getNicId()));
    }
    ...
    @Override
    public void execute() {
        CallContext.current().setEventDetails(String.format("NIC ID: %s", this._uuidMgr.getUuid(Nic.class, getNicId())));
