...
public class Value extends GenericPresetVariable {
    ...
    @PresetVariableDefinition(description = "ID of the resource.", supportedTypes = {QuotaTypes.ALLOCATED_VM, QuotaTypes.BACKUP_OBJECT,
        QuotaTypes.RUNNING_VM, QuotaTypes.VOLUME, QuotaTypes.TEMPLATE, QuotaTypes.ISO, QuotaTypes.SNAPSHOT, QuotaTypes.NETWORK, QuotaTypes.NETWORK_OFFERING, QuotaTypes.VM_SNAPSHOT})
    private String id;

    @PresetVariableDefinition(description = "Name of the resource.", supportedTypes = {QuotaTypes.ALLOCATED_VM, QuotaTypes.BACKUP_OBJECT,
        QuotaTypes.RUNNING_VM, QuotaTypes.VOLUME, QuotaTypes.TEMPLATE, QuotaTypes.ISO, QuotaTypes.SNAPSHOT, QuotaTypes.NETWORK, QuotaTypes.NETWORK_OFFERING, QuotaTypes.VM_SNAPSHOT})
    private String name;
    ...
    @PresetVariableDefinition(description = "OS of the VM/template.", supportedTypes = {QuotaTypes.RUNNING_VM, QuotaTypes.ALLOCATED_VM,
    ...
    @PresetVariableDefinition(description = "The VM that originated the backup object.", supportedTypes = {QuotaTypes.BACKUP_OBJECT})
