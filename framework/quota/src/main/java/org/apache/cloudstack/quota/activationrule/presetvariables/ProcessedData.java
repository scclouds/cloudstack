...
public class ProcessedData extends GenericPresetVariable {
    ...
    @PresetVariableDefinition(description = "The end date of the processed data period.")
    ...
    @PresetVariableDefinition(description = "The start date of the processed data period.")
