...
public class TransactionLegacyTest {
    ...
    @Test
    public void getConnectionUriTestWithoutUri() {
        properties.setProperty("db.cloud.uri", "");

        String result = TransactionLegacy.getConnectionUri(properties, null, "driver", false, "cloud");

        Assert.assertEquals("driver://host:5555/name?autoReconnect=false&someParams", result);
    }

    @Test
    public void getConnectionUriTestWithUri() {
        properties.setProperty("db.cloud.uri", "myFavoriteUri");

        String result = TransactionLegacy.getConnectionUri(properties, null, "driver", false, "cloud");

        Assert.assertEquals("myFavoriteUri", result);
    }
