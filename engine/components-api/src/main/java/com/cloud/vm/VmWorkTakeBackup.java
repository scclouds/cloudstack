...
public class VmWorkTakeBackup extends VmWork {
    ...
    public VmWorkTakeBackup(long userId, long accountId, long vmId, long backupId, String handlerName, String backupProvider, boolean quiesceVm, boolean runningVm) {
