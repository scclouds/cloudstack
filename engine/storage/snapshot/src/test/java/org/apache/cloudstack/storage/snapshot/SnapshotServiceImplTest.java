...
public class SnapshotServiceImplTest {
    ...
    public void getImageStoreForSnapshotTestShouldListFreeImageStoresWithNoHeuristicRule() {
        Mockito.when(heuristicRuleHelperMock.getImageStoreIfThereIsHeuristicRule(Mockito.anyLong(), Mockito.any(HeuristicPurpose.class), Mockito.any(SnapshotInfo.class))).thenReturn(null);
    ...
    public void getImageStoreForSnapshotTestShouldReturnImageStoreReturnedByTheHeuristicRule() {
        ...
        Mockito.when(heuristicRuleHelperMock.getImageStoreIfThereIsHeuristicRule(Mockito.anyLong(), Mockito.any(HeuristicPurpose.class), Mockito.any(SnapshotInfo.class))).thenReturn(dataStore);
        Mockito.when(snapshotMock.getDataCenterId()).thenReturn(DUMMY_ID);
