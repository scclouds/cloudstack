...
import com.cloud.upgrade.dao.Upgrade41801to41802;
import com.cloud.upgrade.dao.Upgrade41802to14803;
import com.cloud.upgrade.dao.Upgrade41803to41804;
import com.cloud.upgrade.dao.Upgrade41804to41805;
import com.cloud.upgrade.dao.Upgrade41805to41806;
import com.cloud.upgrade.dao.Upgrade41806to41807;
import com.cloud.upgrade.dao.Upgrade41807to41808;
import com.cloud.upgrade.dao.Upgrade41808to41809;
import com.cloud.upgrade.dao.Upgrade41809to418010;
...
public class DatabaseUpgradeChecker implements SystemIntegrityChecker {
    ...
    public DatabaseUpgradeChecker() {
        ...
        hierarchy = DatabaseVersionHierarchy.builder()
                ...
                .next("4.16.0.16", new Upgrade41600to41610())
                ...
                .next("4.18.0.0", new Upgrade41800to41801())
                .next("4.18.0.1", new Upgrade41801to41802())
                .next("4.18.0.2", new Upgrade41802to14803())
                .next("4.18.0.3", new Upgrade41803to41804())
                .next("4.18.0.4", new Upgrade41804to41805())
                .next("4.18.0.5", new Upgrade41805to41806())
                .next("4.18.0.6", new Upgrade41806to41807())
                .next("4.18.0.7", new Upgrade41807to41808())
                .next("4.18.0.8", new Upgrade41808to41809())
                .next("4.18.0.9", new Upgrade41809to418010())
                .build();
    }
