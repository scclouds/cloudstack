...
public class SnapshotDaoImpl extends GenericDaoBase<SnapshotVO, Long> implements SnapshotDao {
    ...
    protected void init() {
        ...
        InstanceIdSearch.and(NOT_TYPE, InstanceIdSearch.entity().getSnapshotType(), SearchCriteria.Op.NEQ);
    ...
    public List<SnapshotVO> listByInstanceId(long instanceId, Snapshot.State... status) {
        ...
        sc.setJoinParameters(INSTANCE_SNAPSHOTS, STATE, Volume.State.Ready, Volume.State.Snapshotting);
    ...
    public List<SnapshotVO> listByInstanceIdAndNotTypeAndStates(long instanceId, Type snapshotType, Snapshot.State... status) {
        ...
        if (snapshotType != null) {
            sc.setParameters(NOT_TYPE, snapshotType.ordinal());
        }
