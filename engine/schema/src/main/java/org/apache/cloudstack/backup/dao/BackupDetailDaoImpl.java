...
public class BackupDetailDaoImpl extends ResourceDetailsDaoBase<BackupDetailVO> implements BackupDetailDao {
    ...
    public void addDetail(long resourceId, String key, String value, boolean display) {
        super.addDetail(new BackupDetailVO(resourceId, key, value));
    }
